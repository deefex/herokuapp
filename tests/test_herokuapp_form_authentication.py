...
class LoginTest(unittest.TestCase):
    ...
    def test_form_authentication_successful_login(self):
        LoginPage(self.driver).attempt_login("tomsmith", "SuperSecretPassword!")
    ...
    def test_form_authentication_invalid_username(self):
        login_page = LoginPage(self.driver).attempt_login("bobsmith", "SuperSecretPassword!")
    ...
    def test_form_authentication_invalid_password(self):
        login_page = LoginPage(self.driver).attempt_login("tomsmith", "NotMyPassword!")
        assert login_page.login_error_displayed()
